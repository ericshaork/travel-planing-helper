...
export default function HomePage() {
  return (
    <div className="paper-texture flex min-h-screen flex-col overflow-x-clip text-[var(--ink)]">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-4 pb-4 pt-2 sm:px-8 sm:pb-16 sm:pt-14">
        <section className="grid flex-1 items-start gap-5 lg:grid-cols-[minmax(0,0.82fr)_minmax(34rem,1.18fr)] lg:gap-14">
          <div className="min-w-0 max-w-xl pt-1 lg:pt-10">
            ...
            <h1 className="mt-4 text-3xl font-semibold leading-[1.12] tracking-[-0.045em] sm:mt-6 sm:text-6xl">
              别查到凌晨了，
            ...
            <div className="mt-4 rounded-sm border-l-2 border-[var(--sand-deep)] bg-[var(--paper-bright)] px-3 py-2.5 text-xs leading-5 text-[var(--ink-muted)] sm:hidden">
