...
- [ ] desktop 三栏布局空间更稳定
- [ ] 地图区块可读性明显提升
- [ ] 天气模块优先表达“下雨 / 带伞 / 户外适宜度”
- [ ] marker / icon / button / chip 状态表达更统一
- [ ] landing 氛围更完整，但不影响首屏理解
- [ ] `/create /plan /result /trips /login` 全流程无明显视觉回归
- [ ] mobile 无严重破版
